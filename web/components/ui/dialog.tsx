  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // A tall dialog on a short screen used to run off both ends with no way
        // to reach the buttons: nothing capped its height and the page behind
        // it does not scroll while it is open. dvh, not vh, so the iOS URL bar
